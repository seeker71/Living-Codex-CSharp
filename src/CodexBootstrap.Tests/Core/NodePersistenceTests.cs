...
/// </summary>
    public class NodePersistenceTests
    {
        ...
        {
            _logger = new Log4NetLogger(typeof(NodePersistenceTests));
        ...
        {
            // Arrange
            var registry = new NodeRegistry(_iceStorage, _waterStorage, _logger);
            ...
            iceNodes.Should().Contain(n => n.Id == "test-ice-node");
            waterNodes.Should().NotContain(n => n.Id == "test-ice-node");

            var storedNode = iceNodes.First(n => n.Id == "test-ice-node");
        ...
        public async Task NodeStateTransition_Gas_ShouldNotPersist()
        {
            ...
            iceNodes.Should().NotContain(n => n.Id == "test-gas-node");
            waterNodes.Should().NotContain(n => n.Id == "test-gas-node");
        ...
        public async Task NodeStateTransition_IceToWater_ShouldMoveStorage()
        {
            ...
            var iceNodes1 = await _iceStorage.GetAllIceNodesAsync();
            var waterNodes1 = await _waterStorage.GetAllWaterNodesAsync();
            iceNodes1.Should().Contain(n => n.Id == "transition-node");
            waterNodes1.Should().NotContain(n => n.Id == "transition-node");
        ...
        public async Task NodeStateTransition_WaterToGas_ShouldRemoveFromStorage()
        {
            ...
            _waterStorage.GetAllWaterNodesAsync().Should().Contain(n => n.Id == "water-to-gas-node");
        ...
        public async Task ServerRestart_IceNodes_ShouldSurviveRestart()
        {
            ...
            var registry1 = new NodeRegistry(_iceStorage, _waterStorage, _logger);
            ...
            _iceStorage.GetAllIceNodesAsync().Should().HaveCount(2);
            _iceStorage.GetAllIceNodesAsync().Should().Contain(n => n.Id == "ice-1");
            _iceStorage.GetAllIceNodesAsync().Should().Contain(n => n.Id == "ice-2");
            ...
            var registry2 = new NodeRegistry(_iceStorage, _waterStorage, _logger);
        ...
        public async Task ServerRestart_GasNodes_ShouldNotSurviveRestart()
        {
            ...
            _iceStorage.GetAllIceNodesAsync().Should().NotContain(n => n.Id == "gas-1");
            _waterStorage.GetAllWaterNodesAsync().Should().NotContain(n => n.Id == "gas-1");
        ...
        public async Task EdgePersistence_IceToIce_ShouldPersistInIceStorage()
        {
            ...
            _iceStorage.GetAllEdgesAsync().Should().Contain(e => 
        ...
        public async Task EdgePersistence_MixedStates_ShouldBeGas()
        {
            ...
            _iceStorage.GetAllEdgesAsync().Should().NotContain(e => 
        ...
        public async Task CacheClearAndReload_ShouldRestorePersistentNodes()
        {
            ...
            _iceStorage.GetAllIceNodesAsync().Should().HaveCount(2);
            _waterStorage.GetAllWaterNodesAsync().Should().HaveCount(2);
        ...
        public async Task ComplexStateTransition_IceToWaterToGas_ShouldHandleCorrectly()
        {
            ...
            _iceStorage.GetAllIceNodesAsync().Should().Contain(n => n.Id == "complex-transition");
            ...
            _waterStorage.GetAllWaterNodesAsync().Should().Contain(n => n.Id == "complex-transition");
        ...
        public async Task ConcurrentOperations_ShouldMaintainConsistency()
        {
            ...
            _iceStorage.GetAllIceNodesAsync().Should().HaveCount(expectedIceCount);
            _waterStorage.GetAllWaterNodesAsync().Should().HaveCount(expectedWaterCount);
